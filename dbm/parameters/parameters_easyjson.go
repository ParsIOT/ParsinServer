...
func easyjson224c90e0DecodeParsinServerDbmParameters(in *jlexer.Lexer, out *UserPositionJSON) {
	...
	for !in.IsDelim('}') {
		...
		case "rawlocation":
			out.RawLocation = string(in.String())
		case "bayesguess":
		...
		case "confidentiality":
			out.Confidentiality = float64(in.Float64())
		case "pdrlocation":
...
func easyjson224c90e0EncodeParsinServerDbmParameters(out *jwriter.Writer, in UserPositionJSON) {
	...
	{
		const prefix string = ",\"rawlocation\":"
		if first {
			first = false
			out.RawString(prefix[1:])
		} else {
		...
		out.String(string(in.RawLocation))
	}
	{
	...
	}
	{
		...
		out.Float64(float64(in.Confidentiality))
	}
	{
...
func easyjson224c90e0DecodeParsinServerDbmParameters1(in *jlexer.Lexer, out *TrueLocation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson224c90e0EncodeParsinServerDbmParameters1(out *jwriter.Writer, in TrueLocation) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
// MarshalJSON supports json.Marshaler interface
func (v TrueLocation) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v TrueLocation) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson224c90e0EncodeParsinServerDbmParameters1(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *TrueLocation) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *TrueLocation) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson224c90e0DecodeParsinServerDbmParameters1(l, v)
}
func easyjson224c90e0DecodeParsinServerDbmParameters2(in *jlexer.Lexer, out *TestValidTrack) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson224c90e0EncodeParsinServerDbmParameters2(out *jwriter.Writer, in TestValidTrack) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson224c90e0DecodeParsinServerDbmParameters3(in *jlexer.Lexer, out *ResultsParameters) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson224c90e0EncodeParsinServerDbmParameters3(out *jwriter.Writer, in ResultsParameters) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson224c90e0DecodeParsinServerDbmParameters4(in *jlexer.Lexer, out *PriorParameters) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson224c90e0EncodeParsinServerDbmParameters4(out *jwriter.Writer, in PriorParameters) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson224c90e0DecodeParsinServerDbmParameters5(in *jlexer.Lexer, out *OtherGroupConfig) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson224c90e0EncodeParsinServerDbmParameters5(out *jwriter.Writer, in OtherGroupConfig) {
	out.RawByte('{')
	first := true
	_ = first
	{
		const prefix string = ",\"CoGroup\":"
		if first {
			first = false
			out.RawString(prefix[1:])
		} else {
...
// MarshalJSON supports json.Marshaler interface
func (v OtherGroupConfig) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v OtherGroupConfig) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson224c90e0EncodeParsinServerDbmParameters5(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *OtherGroupConfig) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *OtherGroupConfig) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson224c90e0DecodeParsinServerDbmParameters5(l, v)
}
func easyjson224c90e0DecodeParsinServerDbmParameters6(in *jlexer.Lexer, out *KnnHyperParameters) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson224c90e0EncodeParsinServerDbmParameters6(out *jwriter.Writer, in KnnHyperParameters) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson224c90e0DecodeParsinServerDbmParameters7(in *jlexer.Lexer, out *KnnFingerprints) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "RPFs":
			if in.IsNull() {
				...
				in.Delim('{')
				if !in.IsDelim('}') {
					out.RPFs = make(map[string]float64)
				} else {
					out.RPFs = nil
				}
				for !in.IsDelim('}') {
...
func easyjson224c90e0EncodeParsinServerDbmParameters7(out *jwriter.Writer, in KnnFingerprints) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.FingerprintsInMemory == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v53First := true
			for v53Name, v53Value := range in.FingerprintsInMemory {
				if v53First {
					v53First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.FingerprintsOrdering == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v54, v55 := range in.FingerprintsOrdering {
				if v54 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Clusters == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v56First := true
			for v56Name, v56Value := range in.Clusters {
				if v56First {
					v56First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.Node2FPs == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v59First := true
			for v59Name, v59Value := range in.Node2FPs {
				if v59First {
					v59First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				if v59Value == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
					out.RawString("null")
				} else {
					out.RawByte('[')
					for v60, v61 := range v59Value {
						if v60 > 0 {
							out.RawByte(',')
						}
	...
	}
	{
		...
		if in.RPFs == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			out.RawString(`null`)
		} else {
			out.RawByte('{')
			v62First := true
			for v62Name, v62Value := range in.RPFs {
				if v62First {
					v62First = false
				} else {
					out.RawByte(',')
...
func easyjson224c90e0DecodeParsinServerDbmParameters8(in *jlexer.Lexer, out *KnnConfig) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "KRange":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v63 int
					v63 = int(in.Int())
					out.KRange = append(out.KRange, v63)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "MinClusterRssRange":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v64 int
					v64 = int(in.Int())
					out.MinClusterRssRange = append(out.MinClusterRssRange, v64)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "MaxEuclideanRssDistRange":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v65 int
					v65 = int(in.Int())
					out.MaxEuclideanRssDistRange = append(out.MaxEuclideanRssDistRange, v65)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "GraphFactorRange":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.GraphFactorRange = append(out.GraphFactorRange, v66)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "MaxMovementRange":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v68 int
					v68 = int(in.Int())
					out.MaxMovementRange = append(out.MaxMovementRange, v68)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "BLEFactorRange":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v69 float64
					v69 = float64(in.Float64())
					out.BLEFactorRange = append(out.BLEFactorRange, v69)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "RPFRadiusRange":
			if in.IsNull() {
				in.Skip()
				out.RPFRadiusRange = nil
			} else {
				in.Delim('[')
				if out.RPFRadiusRange == nil {
					if !in.IsDelim(']') {
						out.RPFRadiusRange = make([]float64, 0, 8)
					} else {
						out.RPFRadiusRange = []float64{}
					}
				} else {
					out.RPFRadiusRange = (out.RPFRadiusRange)[:0]
				}
				for !in.IsDelim(']') {
					var v70 float64
					v70 = float64(in.Float64())
					out.RPFRadiusRange = append(out.RPFRadiusRange, v70)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson224c90e0EncodeParsinServerDbmParameters8(out *jwriter.Writer, in KnnConfig) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.MinClusterRssRange == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v73, v74 := range in.MinClusterRssRange {
				if v73 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v74))
	...
	}
	{
		...
		if in.MaxEuclideanRssDistRange == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v75, v76 := range in.MaxEuclideanRssDistRange {
				if v75 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v76))
	...
	}
	{
		...
		if in.GraphFactorRange == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v77, v78 := range in.GraphFactorRange {
				if v77 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.MaxMovementRange == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v81, v82 := range in.MaxMovementRange {
				if v81 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v82))
	...
	}
	{
		...
		if in.BLEFactorRange == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v83, v84 := range in.BLEFactorRange {
				if v83 > 0 {
					out.RawByte(',')
				}
	...
	{
		const prefix string = ",\"RPFRadiusRange\":"
		if first {
			first = false
			out.RawString(prefix[1:])
		} else {
		...
		if in.RPFRadiusRange == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			out.RawString("null")
		} else {
			out.RawByte('[')
			for v85, v86 := range in.RPFRadiusRange {
				if v85 > 0 {
					out.RawByte(',')
				}
...
func (v KnnConfig) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson224c90e0EncodeParsinServerDbmParameters8(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *KnnConfig) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson224c90e0DecodeParsinServerDbmParameters8(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *KnnConfig) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson224c90e0DecodeParsinServerDbmParameters8(l, v)
}
func easyjson224c90e0DecodeParsinServerDbmParameters9(in *jlexer.Lexer, out *FilterMacs) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson224c90e0EncodeParsinServerDbmParameters9(out *jwriter.Writer, in FilterMacs) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v FilterMacs) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson224c90e0EncodeParsinServerDbmParameters9(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *FilterMacs) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson224c90e0DecodeParsinServerDbmParameters9(&r, v)
	return r.Error()
}
